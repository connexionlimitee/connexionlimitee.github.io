const latestText = {
  en: {
    ...
    events: [
      ...
      { text: "April 26, 2025: Mnémosyne, English-language event around poetic homage with Shira Abramovich, Lénaïg Cariou, Carrie Chappell and Alison Koehler, Rerenga Wine, Paris, 14h30" },
      { text: "April 25, 2025, 7pm: Event with Lénaïg Cariou, Shira Abramovich, and Charlotte Blanchard at L’Affranchie bookstore, Lille, France"},
      { text: "April 23, 2025, 7:30pm: event with Shira Abramovich, Lénaïg Cariou, Alex Lachkar and Jeanne Bacharach on The Dream of a Common Language in translation, Librairie La Friche, Paris" },
      { text: "March 15, 2025: Event around Adrienne Rich, with L'Arche (Médiathèque de Saint-Quentin-en-Yvelines)" },
      { text: "March 18, 2025: Workshop, \"Translating gender with Adrienne Rich\" (ENS de Lyon)" },
      { text: "March 6, 2025: Launch for Printemps Rayon Elegie by Kay Gabriel, with How to Become collective (Rerenga Wine, Paris)" },
      { text: "February 25, 2025: France Culture Book Club on Adrienne Rich" },
  ...
  fr: {
    ...
    events: [
      ...
      { text: "26 avril 2025 : Rencontre Mnémosyne, discussion en anglais autour de l'hommage aux poètes, avec Shira Abramovich, Lénaïg Cariou, Carrie Chappell and Alison Koehler, Rerenga Wine, Paris, 14h30" },
      { text: "25 avril 2025 7pm: Rencontre autor d'Adrienne Rich avec Lénaïg Cariou, Shira Abramovich et Charlotte Blanchard à L’Affranchie (Lille)"},
      { text: "23 avril 2025 : Rencontre autour du Rêve d'un langage commun d'Adrienne Rich à la librairie La Friche, à Paris, mercredi 23 avril, 19h30, avec Shira Abramovich, Lénaïg Cariou, Alex Lachkar et Jeanne Bacharach" },
      { text: "15 mars 2025 : Rencontre autour d'Adrienne Rich, avec les éditions de L'Arche (Médiathèque de Saint-Quentin-en-Yvelines)" },
      { text: "18 mars 2025 : atelier \"Traduire le genre avec Adrienne Rich\" (ENS de Lyon)" },
      { text: "6 mars 2025 : Lancement de Printemps Rayon Elegie de Kay Gabriel, avec le collectif How to Become (Rerenga Wine, Paris)" },
      { text: "25 février 2025 : Book Club de France Culture autour d'Adrienne Rich" },
      ...
      {
        text: "Lundi 6 novembre 2023 : Atelier de traduction avec Shira Abramovich à Simmons College"
      },
      {
        text: "Vendredi 13 octobre 2023 : Lecture avec Laura Vazquez au festival Les Inaccoutumes, presenté par La Ménagerie de Verre",
        url: "https://menageriedeverre.com/files/cp-inaccoutumes.pdf",
      },
      {
      ...
      {
        text: "Jeudi 30 mars 2023 - Lecture et entretien d'Eleni Sikelianos et Lénaïg Cariou au Festival Littérature au Centre, à Clermont-Ferrand",
      },
      {
        text: "Samedi 25 mars 2023, 18h30 - Lecture d'Eleni Sikelianos et de ses traductrices à la librairie EXC, à Paris",
      },
      {
